...
public class paintSecond extends JComponent implements environment{
    ...
    private ImageIcon icon2 = new ImageIcon("source/materials/map/second2.png");
    private void paintSecond(Graphics g,int i){
        if (i == 0){
