...
public class paintTheaf extends JComponent implements npcdis{
    private static final int DEFAULT_IMAGEWIDTH = 60;
    private int startX = 0;
    private int startY = 0;
    private Graphics myG;
    private ImageIcon icon = new ImageIcon("source/materials/npc/theaf.png");
    private ImageIcon icon2 = new ImageIcon("source/materials/npc/theaf2.png");
    private void paintTheaf(Graphics g, int i){
        if (i == 0){
