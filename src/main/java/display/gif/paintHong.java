...
public class paintHong extends JComponent implements minionsdis{
    private static final int DEFAULT_IMAGEWIDTH = 60;
    private int startX = 0;
    private int startY = 0;
    private Graphics myG;
    private ImageIcon icon = new ImageIcon("source/materials/minions/h.png");
    private ImageIcon icon2 = new ImageIcon("source/materials/minions/h2.png");
    private void paintHong(Graphics g, int i){
        if ( i == 0){
