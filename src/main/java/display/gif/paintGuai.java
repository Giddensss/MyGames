...
public class paintGuai extends JComponent implements minionsdis{
    private static final int DEFAULT_IMAGEWIDTH = 60;
    private int startX = 0;
    private int startY = 0;
    private Graphics myG;
    private ImageIcon icon = new ImageIcon("source/materials/minions/a.png");
    private ImageIcon icon2 = new ImageIcon("source/materials/minions/a2.png");
    private void paintGuai(Graphics g,int i){
        if ( i == 0){
