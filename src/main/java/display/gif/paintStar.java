...
public class paintStar extends JComponent implements environment{
    private static final int DEFAULT_IMAGEWIDTH = 60;
    private int startX = 0;
    private int startY = 0;
    private Graphics myG;
    private ImageIcon icon = new ImageIcon("source/materials/map/star.png");
    private ImageIcon icon2 = new ImageIcon("source/materials/map/star2.png");
    private void paintStar(Graphics g,int i){
        if (i == 0){
