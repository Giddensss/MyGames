...
public class paintJinDui extends JComponent implements minionsdis{
    private static final int DEFAULT_IMAGEWIDTH = 60;
    private int startX = 0;
    private int startY = 0;
    private Graphics myG;
    private ImageIcon icon = new ImageIcon("source/materials/minions/j.png");
    private ImageIcon icon2 = new ImageIcon("source/materials/minions/j2.png");
    private void paintJinDui(Graphics g, int i){
        if ( i == 0){
